      ...
      <div className="p-7">
        ...
        <div className="grid grid-cols-2 rounded-xl overflow-hidden border border-gray-200 mb-5">
          <div className="p-3 bg-[#E6F7F1] text-center cursor-pointer" onClick={() => router.push(selId?`/persona/add?id=${selId}`:'/persona/add')}>
            ...
            <div className="text-sm font-bold text-[#0F6E56] mt-0.5">페르소나 정의 완료</div>
            <div className="text-[10px] text-[#0F6E56] mt-0.5">← 클릭하여 수정</div>
          </div>
          <div className="p-3 bg-[#1D9E75] text-center">
            ...
            <div className="text-[10px] text-white/70 mt-0.5">대본 · 씬 · 인플루언서</div>
          </div>
        </div>

        {/* 페르소나 연결 */}
        <div className="card mb-3.5">
          <div className="card-header"><span className="card-title">연결할 페르소나</span><span className="text-xs text-gray-400">STEP 1에서 정의한 페르소나와 연결</span></div>
