      ...
      <div className="p-7">
        ...
        <div className="grid grid-cols-2 rounded-xl overflow-hidden border border-gray-200 mb-5">
          <div className="p-3 bg-[#1D9E75] text-center">
            ...
            <div className="text-[10px] text-white/70 mt-0.5">누구에게 · 무슨 고민 · 무슨 감정</div>
          </div>
          <div className="p-3 bg-gray-100 text-center">
            ...
            <div className="text-[10px] text-gray-400 mt-0.5">대본 · 씬 · 인플루언서 연결</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3.5 items-start">
            ...
            <div className="card">
              ...
              <div className="card-body space-y-3">
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-1">지금 이 순간 어디서 뭘 하고 있는 구체적인 한 명</p>
                </div>
                <div>
          ...
          <div className="space-y-3.5">
                ...
                <div className="flex flex-wrap gap-1.5 min-h-6">
                  {form.tags.map((t,i) => (
                    <span key={t} className="inline-flex items-center gap-1 chip chip-green text-xs">
                      {t}
                      <button onClick={() => set('tags', form.tags.filter((_,j)=>j!==i))} className="text-[#0F6E56] hover:text-red-500">✕</button>
                    </span>
                  ))}
                </div>
              </div>
            ...
            <div className="card bg-[#E6F7F1] border-[#A7E3CE]">
              <div className="card-body text-xs text-[#0F6E56] leading-relaxed">
                ✅ 저장 후 STEP 2에서<br/>
                ✅ 대본 작성<br/>
                ✅ 씬 배치 가이드<br/>
                ✅ 인플루언서 후보 연결<br/>
